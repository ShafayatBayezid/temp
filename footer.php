  ...
  <div class="container">
    ...
    <div class="row footer-middle">
      ...
      <div class="col-lg-3  col-md-6">
        <h2>Get In Touch </h2>
        <ul>
          <li><a href="tel:17868420320"><i class="fa-solid fa-phone-volume"></i>+1 786.842.0320</a></li>
          <li><a href="mailto:sales@anncarequipment.com"><i
                class="fa-regular fa-envelope"></i>sales@anncarequipment.com</a></li>
          <li><a href="#"><i class="fa-solid fa-location-dot"></i>7275 NW 68th Street, Bay #9
              Miami, FL 33166</a></li>
        </ul>
      </div>
      ...
      <div class="col-lg-3  col-md-6">
        ...
        <a href="#" class="btn-menu-top">Request A Quote</a>
      </div>
...
<section class="copy-right-area">
  <div class="container">
    <div class="row text-center">
      <div class="col">
        <p>Copyright ©tradella international 2020</p>
      </div>
    </div>
  </div>
</section>
